...
import (
	"fmt"
	"github.com/dfree1645/goa-websocket-study/client"
	"github.com/dfree1645/goa-websocket-study/tool/cli"
...
func main() {
	...
	app := &cobra.Command{
		Use:   "websocket test-cli",
		Short: `CLI client for the websocket test service ()`,
	}
	...
	c.UserAgent = "websocket test-cli/0"
